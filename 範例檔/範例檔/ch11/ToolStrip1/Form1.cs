...
namespace ToolStrip1
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            toolStripButton1.Click += new EventHandler(細明體ToolStripMenuItem_Click);
            toolStripButton2.Click += new EventHandler(新細明體ToolStripMenuItem_Click);
            toolStripButton3.Click += new EventHandler(標楷體ToolStripMenuItem_Click);
        }
